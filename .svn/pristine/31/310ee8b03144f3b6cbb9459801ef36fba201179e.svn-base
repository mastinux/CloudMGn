...
Define_Module(CloudCongestionControl);

CloudCongestionControl::CloudCongestionControl()
{
    timerMessage = NULL;
}
...
void CloudCongestionControl::initialize()
{
...
void CloudCongestionControl::handleMessage(cMessage *msg)
{
    ASSERT(msg==timerMessage);
    simtime_t t, trand;
    int ngates, i;
    // create new message
    CloudCongestionUpdate *congMsg= new CloudCongestionUpdate("CongUpdate");
